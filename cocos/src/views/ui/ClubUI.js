...
var ClubUI = UIBase.extend({
    ...
    init_bottom_panel:function () {
        ...
        var share_title = "茶楼(欢乐比牌),ID:" + this.club.club_id.toString();
    ...
    update_specify_desk:function (index, table_value) {
        ...
        var values = (table_value & 1) + ((table_value & 2) >> 1) + ((table_value & 4) >> 2) + ((table_value & 8) >> 3) + ((table_value & 16) >> 4) + ((table_value & 32) >> 5);
