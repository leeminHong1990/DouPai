...
var GameConfigUI = UIBase.extend({
    ...
    change_color: function () {
        ...
        if (h1global.curUIMgr.roomLayoutMgr) {
            h1global.curUIMgr.roomLayoutMgr.updateBackground(cc.sys.localStorage.getItem("GAME_ROOM_UI"), gameBgType);
        }
    },
    ...
    update_state: function () {
        ...
        if (player && player.curGameRoom) {
            ...
            this.close_btn.setVisible(serverSitNum === 0 && player.curGameRoom.curRound <= 0);
            this.out_btn.setVisible((serverSitNum !== 0 && player.curGameRoom.curRound <= 0) || role === const_val.GAME_ROLE_VIEWER);
        }
    },
});