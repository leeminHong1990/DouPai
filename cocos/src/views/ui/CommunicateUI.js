...
var CommunicateUI = UIBase.extend({
	...
	update_msg_scroll:function () {
        var player = h1global.player();
        var self = this;
        // var msg_list = cc.sys.localStorage.getItem("VOICE_LANGUAGE") === "standard" ? const_val.MESSAGE_LIST.slice(0,8) : const_val.MESSAGE_LIST.slice(8,const_val.MESSAGE_LIST.length);
		var msg_list = const_val.MESSAGE_LIST;
		var origin_idx = 0; /*cc.sys.localStorage.getItem("VOICE_LANGUAGE") === "standard" ? 0 : 8;*/
        // 语音文字
