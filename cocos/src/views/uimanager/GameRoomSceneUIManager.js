var GameRoomSceneUIManager = UIManagerBase.extend({
    onCreate: function () {
        ...
        var initUIClassNameList = ["GameRoom2DUI", /*"GameRoom3DUI",*/ "GameRoomPrepareUI", "GameRoomInfoUI", "AudioRecordUI", "SettlementUI", "ResultUI", "HelpUI", /*"GameConfigUI"*/ "ConfigUI" , "GamePlayerInfoUI", "CommunicateUI", "ShareUI", "ApplyCloseUI", "GPSUI" ,"ToastUI"];
        ...
        this.roomLayoutMgr.updateBackground(game_room_ui_type, game_room_bg_type);
    },
